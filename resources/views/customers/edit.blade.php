    ...
    <div>
        <div class="d-flex justify-content-between align-items-center">
            <p class="fs-4 mb-0">
                ...
                <span>Modifier le client - {{$customer->fullname}}</span>
            </p>
        </div>
        <form class="mt-4 w-75" action="{{route('customers.update', $customer)}}" method="post">
            @method("PUT")
            @csrf
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input class="form-control @error('lastname') is-invalid @enderror" name="lastname"
                           id="lastname"
                           type="text" value="{{old('lastname') ?? $customer->lastname}}"/>
                    @error('lastname')
                ...
                <div class="col">
                    ...
                    <input class="form-control @error('firstname') is-invalid @enderror" name="firstname"
                           id="firstname"
                           type="text" value="{{old('firstname') ?? $customer->firstname}}"/>
                    @error('firstname')
                    <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="mobile1" class="form-control @error('mobile1') is-invalid @enderror" id="mobile1"
                       value="{{ old('mobile1') ?? $customer->mobile1 }}">
                @error('mobile1')
                <div class="invalid-feedback">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input class="form-control @error('street_number') is-invalid @enderror" name="street_number"
                           id="street_number"
                           type="text" value="{{old('street_number') ?? $customer->address->street_number}}"/>
                    @error('street_number')
                    <div class="invalid-feedback">
                ...
                <div class="col">
                    ...
                    <input class="form-control @error('street_name') is-invalid @enderror" name="street_name"
                           id="street_name"
                           type="text" value="{{old('street_name') ?? $customer->address->street_name}}"/>
                    @error('street_name')
                    <div class="invalid-feedback">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input class="form-control @error('zip_code') is-invalid @enderror" name="zip_code"
                           id="zip_code"
                           type="text" value="{{old('zip_code') ?? $customer->address->zip_code}}"/>
                    @error('zip_code')
                    <div class="invalid-feedback">
                ...
                <div class="col">
                    ...
                    <input class="form-control @error('city') is-invalid @enderror" name="city"
                           id="city"
                           type="text" value="{{old('city') ?? $customer->address->city}}"/>
                    @error('city')
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
