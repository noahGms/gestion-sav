...
document.addEventListener('DOMContentLoaded', function () {
  var collapseEl = document.getElementById('settings-collapse');
  ...
  var collapseLink = document.getElementsByClassName('collapse-link');

  var _iterator = _createForOfIteratorHelper(collapseLink),
      _step;
